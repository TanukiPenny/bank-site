    ...
    return (
        <>
            <div className="basicInfo">
                <Pfp></Pfp>
                <p className="infoText">Hai, I'm Penny! I am {ageFromDateOfBirthday(new Date(2001, 10, 18))} years old and currently attending university for computer science. I made this
